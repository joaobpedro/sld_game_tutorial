...
// Animation constants
extern const float SpriteWidth = 32;
extern const float SpriteHeight = 32;
extern const float padding = 0;
extern const int WalkingAnimationFrames = 6;
extern const int WalkingAnimationsFramesperSprite = 6;
