...
## NOTES on windows
- [ ] needed to remove SDL_main from all files execpt in the main.cpp
- [ ] needed to remove min and max args from the my randomfunction
- [ ] needed to copy the Assets folder to the Debug folder, because the paths as relative and hardcoded